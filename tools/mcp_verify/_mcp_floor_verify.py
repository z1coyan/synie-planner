#!/usr/bin/env python3
"""Verify floor material UX via Godot AI MCP at http://127.0.0.1:8000/mcp"""
import json
import sys
import time
import urllib.error
...
SESSION = None
OUT = Path(r"C:\Users\PA602\Code\synie-planner\_mcp_floor_verify.json")
...
def main():
    ...
    _, init = rpc(
        "initialize",
        {
            ...
            "capabilities": {},
            "clientInfo": {"name": "floor-verify", "version": "1.0"},
        },
        id_=1,
    )
